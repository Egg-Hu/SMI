# this page is used for the baseline, psaq-vit, refer to https://github.com/zkkli/PSAQ-ViT
...
class GenerativeModel(abc.ABC, nn.Module):
    """Base class inherited by all generative quantization in pytorch-generative.
    Provides:
